        ...
        {sent ? (
          <div style={{ textAlign: 'center', padding: '1rem' }}>
            ...
            <button
              ...
              style={{ marginTop: '1.25rem', padding: '0.75rem 1.5rem', background: 'var(--border2)', border: '2px solid var(--border)', borderRadius: '0.5rem', color: 'var(--text)', cursor: 'pointer', fontWeight: 700 }}
            >
              Back to Sign In
            </button>
          </div>
