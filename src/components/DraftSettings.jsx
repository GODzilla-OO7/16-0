...
export default function DraftSettings({ mode, onStart, onBack }) {
  ...
  const S = {
    ...
    toggle: (on) => ({ width: 44, height: 24, borderRadius: '999px', background: on ? '#C8102E' : 'var(--border)', position: 'relative', cursor: 'pointer', transition: 'background 0.2s', flexShrink: 0, border: 'none' }),
